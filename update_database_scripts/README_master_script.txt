...
createServerAssociAndClumpsFiles.py- A Python script that generates association and clump files that can be downloaded using the CLI. TODO more here! @Liz @Maddy
