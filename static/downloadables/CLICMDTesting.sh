...
# create the output details directory and file if they don't exist
mkdir -p "${outputDetails%/*}" && touch "$outputDetails" || exit
...
for i in "../sample.vcf" "../sample.txt"; do #TODO - we will need to add in the output files txt or vcf depending
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test0${fileType}.tsv" -c $pvalue -r $refGen -p $pop
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test1a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -i "$studyID" -e "european" -v 'true' -g "f" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test1b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -i "$studyID" -e "european" -v 'true' -g "f" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test1b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -i "$studyID" -e "european" -v 'true' -g "f" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test3${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test4${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test5${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait1" -t "$trait2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test7${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test8${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType1" -k "$studyType2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test10${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "$studyID"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test11${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "GCST000003"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test12${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "$studyID1" -i "$studyID2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test14${fileType}.tsv" -c $pvalue -r $refGen -p $pop -e "$ethnicity"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test15${fileType}.tsv" -c $pvalue -r $refGen -p $pop -e "$ethnicity1" -e "$ethnicity2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test17${fileType}.tsv" -c $pvalue -r $refGen -p $pop -v
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test19${fileType}.tsv" -c $pvalue -r $refGen -p $pop -g "Male"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test21a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test21b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test21b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test23${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test24${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait1" - t "$trait2" -k "$studyType1" -k "$studyType2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test25a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test25b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test25b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test27${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -i "$studyID"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test28${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait1" -t "$trait2" -i "$studyID1" -i "$studyID2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test29a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -i "$studyID" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test29b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -i "$studyID" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test29b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -i "$studyID" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test31${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -e "$ethnicity"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test32${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType1" -k "$studyType2" -e "$ethnicity1" -e "$ethnicity2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test33a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -e "$ethnicity" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test33b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -e "$ethnicity" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test33b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -e "$ethnicity" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test35${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -i "$studyID"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test36${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType1" -k "$studyType2" -i "$studyID1" -i "$studyID2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test37a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -i "$studyID" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test37b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -i "$studyID" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test37b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -i "$studyID" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test39${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -e "$ethnicity"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test40${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType1" -k "$studyType2" -e "$ethnicity1" -e "$ethnicity2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test41a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -e "$ethnicity" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test41b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -e "$ethnicity" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test41b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "HI" -e "South Asian" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test43${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "$studyID" -e "$ethnicity"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test44${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "$studyID1" -i "$studyID2" -e "$ethnicity1" -e "$ethnicity2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test45a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "$studyID" -e "$ethnicity" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test45b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "$studyID" -e "$ethnicity" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test45b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "$studyID" -e "$ethnicity" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test47${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -i "$studyID"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test48${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait1" -t "$trait2" -k "$studyType1" -k "$studyType2" -i "$studyID1" -e "$studyID2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test49a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -i "$studyID" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test49b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -i "$studyID" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test49b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -i "$studyID" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test51${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -e "$ethnicity"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test52${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait1" -t "$trait2" -k "$studyType1" -k "$studyType2" -e "$ethnicity1" -e "$ethnicity2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test53a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -e "$ethnicity" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test53b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -e "$ethnicity" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test53b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -e "$ethnicity" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test55${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -i "$studyID" -e "$ethnicity"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test56${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait1" -t "$trait2" -i "$studyID1" -i "$studyID2" -e "$ethnicity1" -e "$ethnicity2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test57a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -i "$studyID" -e "$ethnicity" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test57b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -i "$studyID" -e "$ethnicity" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test57b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -i "$studyID" -e "$ethnicity" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test59${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -i "$studyID" -e "$ethnicity"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test60${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType1" -k "$studyType2" -i "$studyID1" -i "$studyID2" -e "$ethnicity1" -e "$ethnicity2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test61a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -i "$studyID" -e "$ethnicity" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test61b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -i "$studyID" -e "$ethnicity" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test61b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "$studyType" -i "$studyID" -e "$ethnicity" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test63${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -i "$studyID" -e "$ethnicity"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test64${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait1" -t "$trait2" -k "$studyType1" -k "$studyType2" -i "$studyID1" -i "$studyID2" -e "$ethnicity1" -e "$ethnicity2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test65a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -i "$studyID" -e "$ethnicity" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test65b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -i "$studyID" -e "$ethnicity" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test65b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "$trait" -k "$studyType" -i "$studyID" -e "$ethnicity" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test67${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t 'pink'
    echo -e "\n\n\n"
    
    # test 68 (test 67 without internet)
    # echo -e "Test 68-- -f $i -o $outputFolder/test68${fileType}.tsv -c $pvalue -r $refGen -p $pop -t 'pink'"
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test68${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t 'pink'
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test69${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k 'HE'
    echo -e "\n\n\n"
    
    # test 70 (test 69 without internet)
    # echo -e "Test 70-- -f $i -o $outputFolder/test70${fileType}.tsv -c $pvalue -r $refGen -p $pop -k 'HE'"
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test70${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k 'HE'
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test71${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "GCST"
    echo -e "\n\n\n"
    
    # test 72 (test 71 without internet)
    # echo -e "Test 72-- -f $i -o $outputFolder/test72${fileType}.tsv -c $pvalue -r $refGen -p $pop -i "GCST""
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test72${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "GCST"
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test73${fileType}.tsv" -c $pvalue -r $refGen -p $pop -e "Not ethnicity"
    # echo -e "\n\n\n"
    ...
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test74${fileType}.tsv" -c $pvalue -r $refGen -p $pop -e "Not ethnicity"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test75${fileType}.tsv" -c $pvalue -r $refGen -p $pop -v
    echo -e "\n\n\n"
    
    # test 76 (test 75 without internet)
    # echo -e "Test 76-- -f $i -o $outputFolder/test76${fileType}.tsv -c $pvalue -r $refGen -p $pop -v"
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test76${fileType}.tsv" -c $pvalue -r $refGen -p $pop -v
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test77${fileType}.tsv" -c $pvalue -r $refGen -p $pop -g "he"
    # echo -e "\n\n\n"
    
    # test 78 (test 77 without internet)
    # echo -e "Test 78-- -f $i -o $outputFolder/test78${fileType}.tsv -c $pvalue -r $refGen -p $pop -g "he""
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test78${fileType}.tsv" -c $pvalue -r $refGen -p $pop -g "he"
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test79${fileType}.tsv" -c $pvalue -r $refGen -p $pop -s "he"
    echo -e "\n\n\n"
    
    # test 80 (test 79 without internet)
    # echo -e "Test 80-- -f $i -o $outputFolder/test80${fileType}.tsv -c $pvalue -r $refGen -p $pop -s "he""
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test80${fileType}.tsv" -c $pvalue -r $refGen -p $pop -s "he"
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test81${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -k "HW"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test82a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -k "HW" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test82b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -k "HW" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test82b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -k "HW" -s "2"
    echo -e "\n\n\n"
    ...
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test83${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -k "HW"
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test84${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -i "GCST"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test85a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -i "GCST" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test85b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -i "GCST" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test85b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -i "GCST" -s "2"
    echo -e "\n\n\n"
    ...
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test86${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -i "GCST"
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test87${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -e "europ"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test88a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -e "europ" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test88b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -e "europ" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test88b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -e "europ" -s "2"
    echo -e "\n\n\n"
    ...
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test89${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "pink" -e "europ"
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test90${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "Hi" -i "GCST"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test91a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "Ho" -i "gcst" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test91b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "Ho" -i "gcst" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test91b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "Ho" -i "gcst" -s "2"
    echo -e "\n\n\n"
    ...
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test92${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "Hi" -i "GCST"
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test93${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "HI" -e "bogus"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test94a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "HI" -e "bogus" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test94b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "HI" -e "bogus" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test94b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "HI" -e "bogus" -s "2"
    echo -e "\n\n\n"
    ...
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test95${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "HI" -e "bogus"
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test96${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "gcst" -e "bogus"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test97a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "gcst" -e "bogus" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test97b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "gcst" -e "bogus" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test97b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "gcst" -e "bogus" -s "2"
    echo -e "\n\n\n"
    ...
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test98${fileType}.tsv" -c $pvalue -r $refGen -p $pop -i "gcst" -e "bogus"
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test99${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -k "HI" -i "gcst"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test100a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -k "HI" -i "gcst" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test100b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -k "HI" -i "gcst" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test100b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -k "HI" -i "gcst" -s "2"
    echo -e "\n\n\n"
    ...
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test101${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -k "HI" -i "gcst"
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test102${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -k "HI" -e "bogus"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test103a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -k "HI" -e "bogus" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test103b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -k "HI" -e "bogus" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test103b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -k "HI" -e "bogus" -s "2"
    echo -e "\n\n\n"
    ...
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test104${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -k "HI" -e "bogus"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test105${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -i "gcst" -e "bogus"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test106a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -i "gcst" -e "bogus" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test106b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -i "gcst" -e "bogus" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test106b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -i "gcst" -e "bogus" -s "2"
    echo -e "\n\n\n"
    ...
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test107${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "flubber" -i "gcst" -e "bogus"
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test108${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "HI" -i "gcst" -e "bogus"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test109a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "HI" -i "gcst" -e "bogus" -s "2"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test109b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "HI" -i "gcst" -e "bogus" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test109b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "HI" -i "gcst" -e "bogus" -s "2"
    echo -e "\n\n\n"
    ...
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test110${fileType}.tsv" -c $pvalue -r $refGen -p $pop -k "HI" -i "gcst" -e "bogus"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test111${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "yeet" -k "HI" -i "gcst" -e "bogus"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test112a${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "yeet" -k "HI" -i "gcst" -e "bogus" -s "2"
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test112b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "yeet" -k "HI" -i "gcst" -e "bogus" -s "1"
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test112b${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "yeet" -k "HI" -i "gcst" -e "bogus" -s "2"
    echo -e "\n\n\n"
    ...
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test113${fileType}.tsv" -c $pvalue -r $refGen -p $pop -t "yeet" -k "HI" -i "gcst" -e "bogus"
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f "../savcf" -o "$outputFolder/test114${fileType}.tsv" -c $pvalue -r $refGen -p $pop
    echo -e "\n\n\n"
    
    # test 115 (test 114 without internet)
    # echo -e "Test 115-- -f ../savcf -o $outputFolder/test115${fileType}.tsv -c $pvalue -r $refGen -p $pop"
    # /usr/bin/time -v ./runPrsCLI.sh -f "../savcf" -o "$outputFolder/test115${fileType}.tsv" -c $pvalue -r $refGen -p $pop 
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "output.hem" -c $pvalue -r $refGen -p $pop 
    echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test118${fileType}.tsv" -c $pvalue -r "hg1997" -p $pop
    echo -e "\n\n\n"
    
    # test 119 (test 118 without internet)
    # echo -e "Test 119-- -f $i -o $outputFolder/test119${fileType}.tsv -c $pvalue -r hg1997 -p $pop"
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test119${fileType}.tsv" -c $pvalue -r "hg1997" -p $pop
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test120${fileType}.tsv" -c "lala" -r $refGen -p $pop
    echo -e "\n\n\n"
    
    # test 121 (test 120 without internet)
    # echo -e "Test 121-- -f $i -o $outputFolder/test121${fileType}.tsv -c lala -r $refGen -p $pop"
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$soutputFolder/test121${fileType}.tsv" -c "lala" -r $refGen -p $pop
    # echo -e "\n\n\n"
    ...
    /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test122${fileType}.tsv" -c $pvalue -r $refGen -p "FIF"
    echo -e "\n\n\n"
    
    # test 123 (test 122 without internet)
    # echo -e "Test 123-- -f $i -o $outputFolder/test123${fileType}.tsv -c $pvalue -r $refGen -p FIF"
    # /usr/bin/time -v ./runPrsCLI.sh -f $i -o "$outputFolder/test123${fileType}.tsv" -c $pvalue -r $refGen -p "FIF"
    # echo -e "\n\n\n"
done
