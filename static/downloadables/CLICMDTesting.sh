...
for i in "../sample.vcf" "../sample.txt"; do #TODO - we will need to add in the output files txt or vcf depending
    ...
    echo -e "Test 1a-- -f $i -o $outputFolder/test1a${fileType}.tsv -c $pvalue -r $refGen -p $pop -t $trait -k $studyType -i $studyID -e european -v true -g f -s 2" >> $outputDetails
    ...
    echo -e "Test 1b-- -f $i -o $outputFolder/test1b${fileType}.tsv -c $pvalue -r $refGen -p $pop -t $trait -k $studyType -i $studyID -e european -v true -g f -s 1&2" >> $outputDetails
    ...
    # test 17 (-v)
    echo -e "Test 17-- -f $i -o $outputFolder/test17${fileType}.tsv -c $pvalue -r $refGen -p $pop -v true" >> $outputDetails
    ./runPrsCLI.sh -f $i -o "$outputFolder/test17${fileType}.tsv" -c $pvalue -r $refGen -p $pop -v "true"
    ...
    # test 75 (bad -v)
    echo -e "Test 75-- -f $i -o $outputFolder/test75${fileType}.tsv -c $pvalue -r $refGen -p $pop -v "yeet""
    ./runPrsCLI.sh -f $i -o "$outputFolder/test75${fileType}.tsv" -c $pvalue -r $refGen -p $pop -v "yeet"

    # test 76 (test 75 without internet)
    # echo -e "Test 76-- -f $i -o $outputFolder/test76${fileType}.tsv -c $pvalue -r $refGen -p $pop -v "yeet""
    # ./runPrsCLI.sh -f $i -o "$outputFolder/test76${fileType}.tsv" -c $pvalue -r $refGen -p $pop -v "yeet"
    ...
    echo -e "Test 82b-- -f $i -o $outputFolder/test82b${fileType}.tsv -c $pvalue -r $refGen -p $pop -t "pink" -k "HW" -s "1""
    ...
    echo -e "Test 85b-- -f $i -o $outputFolder/test85b${fileType}.tsv -c $pvalue -r $refGen -p $pop -t "pink" -i "GCST" -s "1""
    ...
    echo -e "Test 88b-- -f $i -o $outputFolder/test88b${fileType}.tsv -c $pvalue -r $refGen -p $pop -t "pink" -e "europ" -s "1""
    ...
    echo -e "Test 91b-- -f $i -o $outputFolder/test91b${fileType}.tsv -c $pvalue -r $refGen -p $pop -k "Ho" -i "gcst" -s "1""
    ...
    echo -e "Test 94a-- -f $i -o $outputFolder/test94a${fileType}.tsv -c $pvalue -r $refGen -p $pop "HI" -e "bogus" -s "2""
    ./runPrsCLI.sh -f $i -o "$outputFolder/test94a${fileType}.tsv" -c $pvalue -r $refGen -p $pop "HI" -e "bogus" -s "2"
    echo -e "Test 94b-- -f $i -o $outputFolder/test94b${fileType}.tsv -c $pvalue -r $refGen -p $pop "HI" -e "bogus" -s "1""
    ./runPrsCLI.sh -f $i -o "$outputFolder/test94b${fileType}.tsv" -c $pvalue -r $refGen -p $pop "HI" -e "bogus" -s "1"
    ./runPrsCLI.sh -f $i -o "$outputFolder/test94b${fileType}.tsv" -c $pvalue -r $refGen -p $pop "HI" -e "bogus" -s "2"
    ...
    echo -e "Test 97b-- -f $i -o $outputFolder/test97b${fileType}.tsv -c $pvalue -r $refGen -p $pop -i "gcst" -e "bogus" -s "1""
    ...
    echo -e "Test 100b-- -f $i -o $outputFolder/test100b${fileType}.tsv -c $pvalue -r $refGen -p $pop -t "flubber" -k "HI" -i "gcst" -s "1""
    ...
    echo -e "Test 103b-- -f $i -o $outputFolder/test103b${fileType}.tsv -c $pvalue -r $refGen -p $pop -t "flubber" -k "HI" -e "bogus" -s "1""
    ...
    echo -e "Test 106b-- -f $i -o $outputFolder/test106b${fileType}.tsv -c $pvalue -r $refGen -p $pop -t "flubber" -i "gcst" -e "bogus" -s "1""
    ...
    echo -e "Test 109b-- -f $i -o $outputFolder/test109b${fileType}.tsv -c $pvalue -r $refGen -p $pop -k "HI" -i "gcst" -e "bogus" -s "1""
    ...
    echo -e "Test 112b-- -f $i -o $outputFolder/test112b${fileType}.tsv -c $pvalue -r $refGen -p $pop -t "yeet" -k "HI" -i "gcst" -e "bogus" -s "1""
