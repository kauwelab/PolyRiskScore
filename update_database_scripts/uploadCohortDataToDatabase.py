...
def main():
    ...
    summaryTableColumns = "( studyID varchar(20), reportedTrait varchar(255), trait varchar(255), citation varchar(50), min float, max float, median float, rng float, mean float, geomMean float, harmMean varchar(100), stdev float, geomStdev varchar(100), cohort varchar(50) )"
